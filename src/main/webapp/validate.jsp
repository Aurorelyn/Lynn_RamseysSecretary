...
<html>
    ...
    <body>
        ...
        <a id="login" class="authButton" style="display:none;" href="https://discord.com/api/oauth2/authorize?client_id=837022531378085930&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2FPirateLegendValidator%2Fvalidate&response_type=code&scope=identify%20connections">Identify yourself stranger</a>
